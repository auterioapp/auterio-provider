    ...
    <View style={styles.container}>
      ...
      <View style={styles.statusCard}>
        ...
        <View style={styles.helpRow}>
          <Ionicons name="notifications-outline" size={18} color={colors.mutedText} />
      ...
      <TouchableOpacity style={styles.button} onPress={onContinue} activeOpacity={0.88}>
        ...
        <Ionicons name="arrow-forward" size={18} color={colors.surfaceRaised} />
      </TouchableOpacity>
    </View>
  );
}
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: colors.surfaceRaised, paddingHorizontal: 28, paddingTop: 96, paddingBottom: 40, alignItems: 'center' },
  ...
  eyebrow: { color: colors.success, fontSize: 11, fontWeight: '800', letterSpacing: 1.5, marginBottom: 10 },
  title: { color: '#111827', fontSize: 30, lineHeight: 36, fontWeight: '800', marginBottom: 12 },
  description: { color: colors.mutedText, fontSize: 15, lineHeight: 22, textAlign: 'center', marginBottom: 30 },
  ...
  statusInfo: { flex: 1 },
  statusTitle: { color: colors.mutedText, fontSize: 12, fontWeight: '600', marginBottom: 2 },
  ...
  badgeText: { color: colors.info, fontSize: 9, fontWeight: '800', letterSpacing: 0.5 },
  divider: { height: 1, backgroundColor: '#E5E7EB', marginVertical: 14 },
  helpRow: { flexDirection: 'row', alignItems: 'center', gap: 9 },
  helpText: { flex: 1, color: colors.mutedText, fontSize: 12, lineHeight: 17 },
  button: { marginTop: 'auto', width: '100%', backgroundColor: colors.primary, borderRadius: 14, paddingVertical: 17, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 9 },
  buttonText: { color: colors.surfaceRaised, fontSize: 16, fontWeight: '800' },
});
