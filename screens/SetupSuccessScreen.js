    ...
    <View style={styles.container}>
      ...
      <View style={styles.statusCard}>
        ...
        <View style={styles.helpRow}>
          <Ionicons name="notifications-outline" size={18} color="#5E646D" />
...
const styles = StyleSheet.create({
  ...
  description: { color: '#5E646D', fontSize: 15, lineHeight: 22, textAlign: 'center', marginBottom: 30 },
  ...
  statusInfo: { flex: 1 },
  statusTitle: { color: '#5E646D', fontSize: 12, fontWeight: '600', marginBottom: 2 },
  ...
  helpText: { flex: 1, color: '#5E646D', fontSize: 12, lineHeight: 17 },
  button: { marginTop: 'auto', width: '100%', backgroundColor: '#F04416', borderRadius: 14, paddingVertical: 17, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 9 },
